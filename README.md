...
Loan Defaulter Prediction — Project README

Concise, one-page summary answering the five hiring-manager questions. Use this as your GitHub README.md and as the canonical project narrative.

1) Problem Statement & Business Relevance

Problem: Predict whether a borrower will default (loan_status) using LendingClub-style loan application and credit features (≈395K records, 79 features).
...
Random Forest: Robust baseline, interpretable via feature importance.

XGBoost: Strong tabular performer capturing non-linear interactions.

ANN (Keras dense network): Evaluated to test if representation learning helps on large dataset.
